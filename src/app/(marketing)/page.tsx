...
export default function HomePage() {
  ...
  return (
    <section className="w-full relative flex items-center justify-center flex-col px-4 md:px-0 py-8">
        ...
        <Container>
          <div className="flex flex-col items-center justify-center py-20 h-full">
            ...
            <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
              <h1 className="text-4xl capitalize md:text-6xl lg:textxl md:!leading-snug font-semibold text-center text-gradient">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-full divide-x-0 md:divide-x divide-y 
              ...
              {perks.map((perk) => (
                <div key={perk.title} className="flex flex-col items-start px-4 md:px-6 lg:px-8 lg:py-6 py-4">
                  ...
                  <p className="text-start mt-2 lg:text-start text-muted-foreground">
                    {perk.info}
                  </p>
                </div>
              ))}
      ...
      {/* Pricing */}
      <Wrapper className="flex flex-col items-center justify-center py-12 relative">
        <div className="md:block absolute top-0 -right-1/3 w-72 h-72 bg-primary rounded-full blur-[10rem] -z-10"></div>
        <Container>
          <div className="max-w-md mx-auto text-start md:text-center">
            <SectionBadge title="Pricing" />
            <h2 className="text-3xl lg:text-4xl font-semibold mt-6 text-gradient">
        ...
        <Container>
          <LampContainer>
            <div className="flex flex-col items-center justify-center relative w-full text-center">
              <h2 className="text-4xl lg:text-5xl xl:text-6xl lg:!leading-snug font-semibold mt-8 text-gradient">
